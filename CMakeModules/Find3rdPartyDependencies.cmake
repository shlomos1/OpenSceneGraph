...
MACRO(SEARCH_3RDPARTY OSG_3RDPARTY_BIN)
        ...
        FIND_DEPENDENCY(CURL curl/curl.h "libcurl;curllib;libcurl_imp;curl" ${OSG_3RDPARTY_BIN} "D" "")
        ...
        IF(ZLIB_FOUND)
            FIND_DEPENDENCY(PNG png.h "libpng;libpng13;libpng15;libpng16;png;png15;png16" ${OSG_3RDPARTY_BIN} "d" "")
            IF(PNG_FOUND)
                #forcing subsequent FindPNG stuff to not search for other variables.... kind of a hack
                SET(PNG_INCLUDE_DIRS ${PNG_INCLUDE_DIR} CACHE FILEPATH "")
